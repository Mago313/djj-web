      ...
      <div className={styles.formContainer}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
          <div className={styles.formGroup}>
            <h3>Логин</h3>
            <input  {...register("login", { required: true })} type="text" name="login" placeholder="Введите логин" />
            <h3>Пароль</h3>
            <input {...register("password", { required: true })} type="password" name="password" placeholder="Введите пароль" />
          </div>
